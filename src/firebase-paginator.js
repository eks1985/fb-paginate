export default class FirebasePaginator {
  ...
  constructor(ref, options = {}) {
    this.pageSize = options.pageSize ? parseInt(options.pageSize, 10) : 3;
  ...
  initialize() {
    ...
    */
    ...
    console.log("infinite branch");
      let queryPath = this.ref.toString() + '.json?shallow=true';
      if (this.auth) {
      ...
      this.goToPage = (pageNumber) => {
        ...
        this.ref = this.ref.orderByKey().limitToLast(this.pageSize).endAt(this.page.endKey);
